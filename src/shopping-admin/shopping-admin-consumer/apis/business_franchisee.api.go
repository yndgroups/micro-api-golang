...
// @Param franchisee body shopping_admin.BusinessFranchisee true "新增商家入住参数"
...
// @Param accessToken header string true "授权令牌" default(Bearer token)
// @Param franchisee body shopping_admin.BusinessFranchisee true "修改商家入住参数"
// @Success 200 {object} resp.Response "请求成功"
// @Failure 400,500 {object}  resp.Response "请求异常"
...
// @Param accessToken header string true "授权令牌" default(Bearer token)
// @Param pageInfo body req.Request[shopping_admin.BusinessFranchiseeParam] true "查询参数"
// @Success 200 {object} resp.Response "请求成功"
// @Failure 400,500 {object}  resp.Response "请求异常"
